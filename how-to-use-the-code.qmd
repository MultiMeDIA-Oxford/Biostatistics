...
Data importing for the course is already included in the code. **Detailed variable names and their meanings can be found on the [dataset webpage](meet-the-dataset.html#understanding-the-variables)**.
...
👉 **[Class Worksheet](https://www.kaggle.com/code/adriandmcintosh/class-worksheet){target="_blank" rel="noopener noreferrer"}**
...
1. Click on the **Copy & Edit**.
![](image/code.png){fig-align="center" width="80%"}
2. Wait for Kaggle to initialise.
...
1. Click on the cell.
2. Press the **Run current cell** button. Or click the **triangle icon** next to the cell.
...
👉 **[Biostatistics Course GitHub Repository](https://github.com/MultiMeDIA-Oxford/Biostatistics_code){target="_blank" rel="noopener noreferrer"}**
...
1. Click on the cell.
2. Click the **triangle icon** in the cell.
3. Wait for the output to appear.
...
👉 [Biostatistics CWM TT 26 CVD Prediction Competition](https://www.kaggle.com/competitions/biostatistics-cwm-tt-26-cvd-prediction){target="_blank" rel="noopener noreferrer"}
